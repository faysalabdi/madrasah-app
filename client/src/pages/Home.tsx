...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* About section */}
      <section ref={aboutRef} id="about" className={`py-16 bg-neutral-light ${aboutEntry?.isIntersecting ? 'animate-fadeIn' : ''}`}>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-border">
                <h3 className="text-xl font-bold text-primary mb-3 font-amiri">Our Core Values</h3>
            ...
            <div className="md:w-1/2">
              ...
              {/* Timeline */}
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-border">
                <h3 className="text-xl font-bold text-primary mb-4 font-amiri">Our Journey</h3>
      ...
      <section ref={programsRef} id="programs-preview" className={`py-16 bg-white ${programsEntry?.isIntersecting ? 'animate-fadeIn' : ''}`}>
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-primary mb-4 font-amiri">Our Programs</h2>
          <p className="text-center mb-12 max-w-3xl mx-auto">We offer a range of programs designed to meet the educational needs of Muslim children at different ages and stages of development.</p>
      ...
      <section ref={teachersRef} id="faculty-preview" className={`py-16 bg-neutral-light ${teachersEntry?.isIntersecting ? 'animate-fadeIn' : ''}`}>
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-primary mb-4 font-amiri">Our Faculty</h2>
          <p className="text-center mb-12 max-w-3xl mx-auto">Meet our dedicated teachers who bring years of experience in Islamic education and a passion for nurturing young Muslims.</p>
      ...
      <section id="contact-preview" className="py-16 bg-neutral-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-primary mb-6 font-amiri">Contact Us</h2>
          <p className="mb-8 max-w-3xl mx-auto">Have questions about our programs or want to schedule a visit? We'd love to hear from you!</p>
