  ...
  return (
    <main className="min-h-screen py-16">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-primary mb-8 text-center font-amiri">Contact Us</h1>

        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-2xl font-bold text-primary mb-4 font-amiri">Get in Touch</h2>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>Drop students off on time (5:30pm weekdays, 10am Saturdays)</li>
              <li>Pick up students on time and drive carefully</li>
              <li>Ensure student is in clean, neat and correct uniform with clean socks</li>
              ...
              <li>Parents are responsible for cleaning toilet, vomiting or bleeding accidents</li>
            </ul>
          </div>
        </div>
      </div>
